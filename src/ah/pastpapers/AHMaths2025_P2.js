export const advHigherMaths2025P2 = {
  year: 2025,
  papers: [
    {
      paperNumber: 2,
      questions: [
        {
          question: `<small><strong><span style="white-space: nowrap;">2025 P2 Q1</span></strong></small><p>A function is defined by \\(f(x) = \\cos^{-1} 4x.\\)<br>Find \\(f'(x).\\)</p>`,
          answer: `\\(-\\frac{4}{\\sqrt{1 - (4x)^2}}\\) (or \\(-\\frac{4}{\\sqrt{1 - 16x^2}}\\))`,
          videoId: "SoqgtES7sRA",
          timestamp: "16s",
        ...
        {
          question: `<small><strong><span style="white-space: nowrap;">2025 P2 Q2</span></strong></small><p>A curve is defined by the equation \\(2y^2 + 4xe^{2y} = 3x.\\)<br>Find an expression for \\(\\frac{dy}{dx}\\) in terms of \\(x\\) and \\(y.\\)</p>`,
          answer: `\\(\\frac{3 - 4e^{2y}}{4y + 8xe^{2y}}\\)`,
          videoId: "SoqgtES7sRA",
          timestamp: "57s",
          topics: ["Differentiation"],
        ...
        {
          question: `<small><strong><span style="white-space: nowrap;">2025 P2 Q3</span></strong></small><p>Express \\(\\frac{2x^2 - 18x + 4}{(x - 1)(x - 3)(x + 5)}\\) in partial fractions.</p>`,
          answer: `\\(\\frac{1}{x - 1} - \\frac{2}{x - 3} + \\frac{3}{x + 5}\\)`,
          videoId: "SoqgtES7sRA",
          timestamp: "3m29s",
        ...
        {
          question: `<small><strong><span style="white-space: nowrap;">2025 P2 Q5</span></strong></small><p>A curve is defined by \\(y = x^{\\cot x}.\\)<br>Use logarithmic differentiation to find \\(\\frac{dy}{dx}.\\)<br>Write your answer in terms of \\(x.\\)</p>`,
          answer: `\\(x^{\\cot x} \\left( -\\text{cosec}^2 x \\ln x + \\frac{\\cot x}{x} \\right)\\)`,
          videoId: "SoqgtES7sRA",
          timestamp: "11m2s",
          topics: ["Differentiation"],
        ...
        {
          question: `<small><strong><span style="white-space: nowrap;">2025 P2 Q10</span></strong></small><p>Find and fully factorise an expression for \\(\\sum_{r=1}^{n} (r^3 - 3r).\\)</p>`,
          answer: `\\(\\frac{1}{4}n(n + 1)(n - 2)(n + 3)\\)`,
          videoId: "SoqgtES7sRA",
          timestamp: "26m34s",
        ...
        {
          question: `<small><strong><span style="white-space: nowrap;">2025 P2 Q12</span></strong></small><p>Solve the differential equation</p><p>\\(\\frac{d^2y}{dx^2} - 8\\frac{dy}{dx} + 15y = 15x^2 - 31x + 40\\)</p><p>given that \\(y = 4\\) and \\(\\frac{dy}{dx} = 13\\) when \\(x = 0.\\)</p>`,
          answer: `\\(y = -2e^{3x} + 4e^{5x} + x^2 - x + 2\\)`,
          videoId: "SoqgtES7sRA",
          timestamp: "33m",
        ...
        {
          question: `<small><strong><span style="white-space: nowrap;">2025 P2 Q14</span></strong></small><p>Find the general solution of the differential equation</p><p>\\(\\frac{dy}{dx} - \\frac{2}{x}y = x^2 \\sec^2 3x.\\)</p><p>Give your answer in the form \\(y = f(x).\\)</p>`,
          answer: `\\(y = x^2 \\left(\\frac{1}{3} \\tan 3x + c\\right)\\)`,
          videoId: "SoqgtES7sRA",
          timestamp: "44m15s",
          topics: ["Differential Equations"],
        ...
        {
          question: `<small><strong><span style="white-space: nowrap;">2025 P2 Q16</span></strong></small><p>Use integration by parts to find</p><p>\\(\\int e^{2x} \\sin 5x \\,dx.\\)</p>`,
          answer: `\\(\\frac{2}{29}e^{2x} \\sin 5x - \\frac{5}{29}e^{2x} \\cos 5x + c\\)`,
          videoId: "SoqgtES7sRA",
          timestamp: "51m20s",
          topics: ["Integration"],
        ...
        },
        {
          ...
          subtopics: ["Basic operations", "de Moivre's theorem"],
          marks: [2, 1, 2]
        }
      ]
    }
