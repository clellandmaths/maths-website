  ...
  papers: [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: `<p>(a) Scatter plot of stopping distance against tread depth, for example <code class="text-green-800 dark:text-green-400 bg-muted px-1 rounded">plot(Depth, Distance, xlab="tread depth (mm)", ylab="stopping distance (m)")</code></p><p>(b) (i) <code class="text-green-800 dark:text-green-400 bg-muted px-1 rounded">cor(Depth, Distance)</code> gives \\(r=-0.986\\)<br>(ii) There is a very strong negative linear correlation: as tread depth decreases, stopping distance increases.</p><p>(c) <code class="text-green-800 dark:text-green-400 bg-muted px-1 rounded">lm(Distance ~ Depth)</code> gives distance \\(=43.94-2.38\\times\\) depth</p><p>(d) \\(43.94-2.38\\times6.2=29.18\\), so about <strong>29.2 metres</strong></p>`,
          videoId: "VkJiGeFTw9s",
          timestamp: "848s",
