                ...
                <div class="overflow-x-auto mb-6">
                    <table class="w-full text-sm border-collapse">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-card"><td class="border border-muted-hover p-2">Higher rate</td><td class="border border-muted-hover p-2">£43,662-£125,140</td><td class="border border-muted-hover p-2">42%</td></tr>
                            <tr class="bg-card"><td class="border border-muted-hover p-2">Top rate</td><td class="border border-muted-hover p-2">Over £125,140</td><td class="border border-muted-hover p-2">47%</td></tr>
                        </tbody>
                    </table>
                </div>
