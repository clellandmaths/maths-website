                ...
                <div class="overflow-x-auto mb-6">
                    <table class="w-full text-sm border-collapse">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-card"><td class="border border-muted-hover p-2">Starter rate</td><td class="border border-muted-hover p-2">£12,570-£14,876</td><td class="border border-muted-hover p-2">19%</td></tr>
                            <tr class="bg-card"><td class="border border-muted-hover p-2">Basic rate</td><td class="border border-muted-hover p-2">£14,876-£26,561</td><td class="border border-muted-hover p-2">20%</td></tr>
                            <tr class="bg-card"><td class="border border-muted-hover p-2">Intermediate rate</td><td class="border border-muted-hover p-2">£26,561-£43,662</td><td class="border border-muted-hover p-2">21%</td></tr>
