export const higherAppsDataBooklet2023 = {
    ...
    sections: [
                ...
                <div class="overflow-x-auto mb-6">
                    <table class="w-full text-sm border-collapse">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-card"><td class="border border-muted-hover p-2">Starter rate</td><td class="border border-muted-hover p-2">£12,570-£14,732</td><td class="border border-muted-hover p-2">19%</td></tr>
                            <tr class="bg-card"><td class="border border-muted-hover p-2">Basic rate</td><td class="border border-muted-hover p-2">£14,732-£25,688</td><td class="border border-muted-hover p-2">20%</td></tr>
                            <tr class="bg-card"><td class="border border-muted-hover p-2">Intermediate rate</td><td class="border border-muted-hover p-2">£25,688-£43,662</td><td class="border border-muted-hover p-2">21%</td></tr>
                            <tr class="bg-card"><td class="border border-muted-hover p-2">Higher rate</td><td class="border border-muted-hover p-2">£43,662-£150,000</td><td class="border border-muted-hover p-2">41%</td></tr>
                            <tr class="bg-card"><td class="border border-muted-hover p-2">Top rate</td><td class="border border-muted-hover p-2">Over £150,000</td><td class="border border-muted-hover p-2">46%</td></tr>
                        </tbody>
                    </table>
                </div>
        ...
        },
        {
            title: "2. E10 Petrol",
            content: `
                <p class="text-xs text-muted-dim mb-4 italic">The following information is taken from the government's website https://www.gov.uk/guidance/e10-petrol-explained</p>
        ...
        },
        {
            ...
            content: `
                ...
                <ul class="list-disc pl-5 mb-4 space-y-2">
                    <li><code class="text-green-800 dark:text-green-400 bg-muted px-1 rounded">hist (X,col="yellow", main="Histogram of X (units)")</code> - this produces a histogram of the variable X</li>
                    <li><code class="text-green-800 dark:text-green-400 bg-muted px-1 rounded">plot (X, Y, xlab="x-axis label", ylab="y-axis label", main="Scatterplot of Y on X",pch=21,bg="black")</code> - produces a scatter plot of Y on X with the required title, axis labels, and black dots</li>
                    ...
                    <li><code class="text-green-800 dark:text-green-400 bg-muted px-1 rounded">boxplot (X)</code> - produces a boxplot of the numerical variable X</li>
                </ul>
