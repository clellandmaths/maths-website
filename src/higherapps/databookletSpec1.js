        ...
        },
        {
            ...
            content: `
                ...
                <ul class="list-disc pl-5 mb-4 space-y-2">
                    ...
                    <li><code class="text-green-800 dark:text-green-400 bg-muted px-1 rounded">plot (X, Y, xlab="x-axis label", ylab="y-axis label", main="Scatterplot of Y on X",pch=21,bg="black")</code> - produces a scatterplot of X vs Y with black dots of the size specified by 'pch'</li>
                ...
                <ul class="list-disc pl-5 mb-4 space-y-2">
                    <li><code class="text-green-800 dark:text-green-400 bg-muted px-1 rounded">cor.test(age, length)</code> - computes the correlation between X and Y and performs a test of the null hypothesis of zero correlation</li>
