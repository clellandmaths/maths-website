      ...
      topics: [
        {
          ...
          questions: [
            ...
            { question: `A curve is defined by the parametric equations \\(x=t^2+t-1\\), \\(y=2t^2-t+2\\) for all \\(t\\). Show that the point \\(A(-1,\\,5)\\) lies on the curve and obtain an equation of the tangent to the curve at the point A.`, answer: `\\(y=5x+10\\)`, paper: "2002 Q3" },
          ],
        },
      ],
    },
      ...
      topics: [
        {
          ...
          questions: [
            ...
            { ref: "2018 Q2", videoId: "S3lOe8FCO3k", timestamp: 260 },
            ...
            { ref: "2018 Q8", videoId: "S3lOe8FCO3k", timestamp: 893 },
            { ref: "2023 P1 Q4", videoId: "S3lOe8FCO3k", timestamp: 1068 },
            ...
            { ref: "2016 Q9", videoId: "S3lOe8FCO3k", timestamp: 1492 },
            ...
            { ref: "2017 Q16", videoId: "S3lOe8FCO3k", timestamp: 1888 },
            { ref: "2019 Q16", videoId: "S3lOe8FCO3k", timestamp: 2040 },
          ],
        },
      ],
    },
      ...
      topics: [
        {
          name: "Matrices",
          questions: [
            { question: `Matrix \\(A\\) is defined by \\(A=\\begin{pmatrix} -4 & -3<br>6 & 5 \\end{pmatrix}\\). Find: (a) \\(A^{-1}\\) (b) \\(A'\\).`, answer: `(a) \\(A^{-1} = \\frac{1}{2}\\begin{pmatrix} -5 & -3<br>6 & 4 \\end{pmatrix}\\) (b) \\(A' = \\begin{pmatrix} -4 & 6<br>-3 & 5 \\end{pmatrix}\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/matrices#1" },
            { question: `Matrix \\(P=\\begin{pmatrix} -9 & 3<br>n & 4 \\end{pmatrix}\\), where \\(n\\in\\mathbb{R}\\). Find the value of \\(n\\) such that \\(P\\) is singular.`, answer: `\\(n=-12\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/matrices#2" },
            { question: `Matrices \\(A=\\begin{pmatrix} 4 & 2<br>1 & p \\end{pmatrix}\\) and \\(B=\\begin{pmatrix} 8 & 2<br>q & 1 \\end{pmatrix}\\). Given that \\(B=2A'\\), find \\(p\\) and \\(q\\).`, answer: `\\(p=\\frac{1}{2}\\), \\(q=4\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/matrices#3" },
            { question: `Show that \\(A=\\begin{pmatrix} \\frac{3}{5} & -\\frac{4}{5}<br>\\frac{4}{5} & \\frac{3}{5} \\end{pmatrix}\\) is orthogonal.`, answer: `\\(AA' = \\begin{pmatrix} 1 & 0<br>0 & 1 \\end{pmatrix} = I\\), so \\(A\\) is orthogonal.`, solutionUrl: "https://www.maths.scot/advanced-higher/matrices#4" },
            { question: `A square matrix \\(A\\) is said to be symmetric if \\(A'=A\\) and skew-symmetric if \\(A'=-A\\). For any \\(2\\times 2\\) matrix \\(A\\), show that \\(A+A'\\) is symmetric and \\(A-A'\\) is skew-symmetric.`, answer: `Let \\(A=\\begin{pmatrix} a & b<br>c & d \\end{pmatrix}\\). Then \\((A+A')' = A+A'\\), so it is symmetric. \\((A-A')' = -(A-A')\\), so it is skew-symmetric.`, solutionUrl: "https://www.maths.scot/advanced-higher/matrices#5" },
            { question: `\\(A\\) is the matrix \\(\\begin{pmatrix} 3 & 0<br>\\lambda & -2 \\end{pmatrix}\\). Show that \\(A^2\\) can be expressed in the form \\(pA+qI\\), stating the values of \\(p\\) and \\(q\\).`, answer: `\\(A^2 = A+6I\\), so \\(p=1\\), \\(q=6\\).`, solutionUrl: "https://www.maths.scot/advanced-higher/matrices#6" },
            { question: `The matrix \\(A=\\begin{pmatrix} 2 & 3 & 1<br>-1 & \\mu & 4<br>5 & 0 & -2 \\end{pmatrix}\\). Given that the determinant of \\(A\\) is \\(36\\), determine the value of \\(\\mu\\).`, answer: `\\(\\mu=2\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/matrices#7" },
            { question: `Obtain the value(s) of \\(p\\) for which the matrix \\(A=\\begin{pmatrix} p & 2 & 0<br>3 & p & 1<br>0 & -1 & -1 \\end{pmatrix}\\) is singular.`, answer: `\\(p=3\\) or \\(p=-2\\)`, paper: "2015 Q5" },
            { question: `Find the inverse of the non-singular matrix \\(A=\\begin{pmatrix} 1 & 2 & -1<br>-2 & 0 & 1<br>1 & -1 & 0 \\end{pmatrix}\\).`, answer: `\\(A^{-1} = \\begin{pmatrix} 1 & 1 & 2<br>1 & 1 & 1<br>2 & 3 & 4 \\end{pmatrix}\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/matrices#9" },
            { question: `(a) Write down the \\(2\\times 2\\) matrix \\(M_1\\) associated with reflection in the \\(x\\)-axis. (b) Write down the \\(2\\times 2\\) matrix \\(M_2\\) that represents reflection in the line \\(y=-x\\). (c) Find the \\(2\\times 2\\) matrix \\(M_3\\) associated with reflection in the line \\(y=-x\\) followed by reflection in the \\(x\\)-axis. (d) State the single transformation associated with \\(M_3\\).`, answer: `(a) \\(M_1 = \\begin{pmatrix} 1 & 0<br>0 & -1 \\end{pmatrix}\\) (b) \\(M_2 = \\begin{pmatrix} 0 & -1<br>-1 & 0 \\end{pmatrix}\\) (c) \\(M_3 = \\begin{pmatrix} 0 & -1<br>1 & 0 \\end{pmatrix}\\) (d) Anti-clockwise rotation of \\(\\frac{\\pi}{2}\\) radians about the origin.`, solutionUrl: "https://www.maths.scot/advanced-higher/matrices#10" },
            { ref: "2018 Q11" },
            { ref: "2025 P1 Q4" },
          ],
        },
      ...
      topics: [
        {
          ...
          questions: [
            ...
            { ref: "2016 Q5", videoId: "f3CiNu2Jmak", timestamp: 1989 },
            { ref: "2019 Q14", videoId: "f3CiNu2Jmak", timestamp: 2256 },
            { ref: "2023 P1 Q8", videoId: "f3CiNu2Jmak", timestamp: 2497 },
            { ref: "2022 P1 Q6", videoId: "f3CiNu2Jmak", timestamp: 2664 },
            { ref: "2023 P2 Q12", videoId: "f3CiNu2Jmak", timestamp: 2878 },
            { ref: "2024 P2 Q11", videoId: "f3CiNu2Jmak", timestamp: 3196 },
          ],
        },
      ],
    },
      ...
      topics: [
        {
          ...
          questions: [
            ...
            { ref: "2023 P2 Q6", videoId: "nVZV1HfcKPg", timestamp: 1175 },
            ...
            { ref: "2024 P2 Q2", videoId: "nVZV1HfcKPg", timestamp: 2021 },
            { ref: "2019 Q12", videoId: "nVZV1HfcKPg", timestamp: 2183 },
            { ref: "2023 P2 Q9", videoId: "nVZV1HfcKPg", timestamp: 2306 },
            { ref: "2025 P2 Q4", videoId: "nVZV1HfcKPg", timestamp: 0 },
          ],
        },
      ],
    },
      ...
      topics: [
        {
          ...
          questions: [
            ...
            { question: `The sum of the first twenty terms of an arithmetic sequence is \\(320\\). The twenty-first term is \\(37\\). What is the sum of the first ten terms?`, answer: `\\(60\\)`, paper: "2015 Q3" },
            { ref: "2023 P1 Q7" },
            { ref: "2023 P2 Q8" },
            { ref: "2024 P1 Q3" },
            { ref: "2024 P2 Q9" },
