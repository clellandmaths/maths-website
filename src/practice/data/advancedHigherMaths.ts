      ...
      topics: [
        {
          ...
          questions: [
            ...
            { question: `(a) Write down and simplify the general term in the binomial expansion of \\(\\left(\\frac{2}{x}-3x\\right)^{12}\\).<br>(b) Hence, or otherwise, find the coefficient of the term in \\(x^8\\).`, answer: `(a) \\(\\binom{12}{r} 2^{12-r} (-3)^r x^{2r-12}\\)<br>(b) \\(15,588,936\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/binomial-theorem#3" },
            { question: `(a) Write down and simplify the general term in the binomial expansion of \\(\\left(5x+\\frac{2}{x^2}\\right)^{9}\\).<br>(b) Hence, or otherwise, find the term that is independent of \\(x\\).`, answer: `(a) \\(\\binom{9}{r} 5^{9-r} 2^r x^{9-3r}\\)<br>(b) \\(10,500,000\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/binomial-theorem#4" },
            { question: `(a) Find and simplify the general term in the binomial expansion of \\(\\left(3x^2-\\frac{a}{x^3}\\right)^{6}\\), where \\(a > 0\\) is a constant.<br>(b) Given that the coefficient of \\(x^2\\) is \\(19,440\\), find the value of \\(a\\).`, answer: `(a) \\(\\binom{6}{r} 3^{6-r} (-a)^r x^{12-5r}\\)<br>(b) \\(a=4\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/binomial-theorem#5" },
      ...
      topics: [
        {
          ...
          questions: [
            { question: `A complex number \\(z=2-\\sqrt{3}\\,i\\).<br>(a) Write down the complex conjugate \\(\\overline{z}\\).<br>(b) Find \\(z\\overline{z}\\).`, answer: `(a) \\(\\overline{z}=2+\\sqrt{3}\\,i\\)<br>(b) \\(7\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/complex-numbers#1" },
            { question: `\\(z_1=3+4i\\) and \\(z_2=k-12i\\), \\(k\\in\\mathbb{R}\\).<br>(a) Find and simplify \\(z_{1}\\overline{z_2}\\).<br>(b) Find the value of \\(k\\) such that \\(z_{1}\\overline{z_2}\\in\\mathbb{R}\\).`, answer: `(a) \\((3k-48)+(4k+36)i\\)<br>(b) \\(k=-9\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/complex-numbers#2" },
            { question: `\\(z=\\frac{3-i}{2+ni}\\in\\mathbb{R}\\) for some value \\(n\\in\\mathbb{R}\\).<br>(a) Determine the value of \\(n\\).<br>(b) Hence find the value of \\(z\\).`, answer: `(a) \\(n=-\\frac{2}{3}\\)<br>(b) \\(z=\\frac{3}{2}\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/complex-numbers#3" },
            ...
            { question: `The complex number \\(z=1+2i\\) is a root of the equation \\(z^3-5z^2+11z-15=0\\).<br>Find the remaining roots.`, answer: `\\(z=1-2i\\), \\(z=3\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/complex-numbers#7" },
            { question: `The complex number \\(z=1-\\sqrt{3}\\,i\\) is a root of the polynomial equation \\(z^4+3z^2+2z+12=0\\).<br>Find the remaining roots.`, answer: `\\(z=1+\\sqrt{3}\\,i\\) and \\(z=-1\\pm\\sqrt{2}\\,i\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/complex-numbers#8" },
            { question: `The complex number \\(z\\) has been plotted on an Argand diagram in the fourth quadrant with coordinates \\((k\\sqrt{3}, -k)\\).<br>Express \\(z\\) in:<br>(a) Cartesian form<br>(b) polar form.`, answer: `(a) \\(z=k\\sqrt{3}-k\\,i\\)<br>(b) \\(z=2k\\left(\\cos\\left(-\\frac{\\pi}{6}\\right)+i\\sin\\left(-\\frac{\\pi}{6}\\right)\\right)\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/complex-numbers#9" },
            { question: `Two complex numbers are defined as: \\(z=2\\left(\\cos\\frac{\\pi}{4}+i\\sin\\frac{\\pi}{4}\\right)\\), \\(w=3\\left(\\cos\\frac{5\\pi}{6}+i\\sin\\frac{5\\pi}{6}\\right)\\).<br>Express in polar form:<br>(a) \\(zw\\)<br>(b) \\(\\frac{z}{w}\\).`, answer: `(a) \\(6\\left(\\cos\\left(-\\frac{11\\pi}{12}\\right)+i\\sin\\left(-\\frac{11\\pi}{12}\\right)\\right)\\)<br>(b) \\(\\frac{2}{3}\\left(\\cos\\left(-\\frac{7\\pi}{12}\\right)+i\\sin\\left(-\\frac{7\\pi}{12}\\right)\\right)\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/complex-numbers#10" },
      ...
      topics: [
        {
          ...
          questions: [
            ...
            { question: `Consider this differential equation, where \\(x>0\\) and \\(0<y<1\\): \\(x\\,\\frac{dy}{dx}=y-y^2\\).<br>By making use of partial fractions, express \\(y\\) in terms of \\(x\\).`, answer: `\\(y=\\frac{kx}{1+kx}\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/differential-equations#2" },
            { question: `Consider the following differential equation: \\(\\frac{dy}{dx}=\\frac{\\sec y}{y}\\). It is known that \\(y=\\frac{\\pi}{2}\\) when \\(x=\\frac{\\pi}{4}\\).<br>Find the particular solution, in implicit form.`, answer: `\\(y\\sin y+\\cos y = x+\\frac{\\pi}{4}\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/differential-equations#3" },
      ...
      topics: [
        {
          ...
          questions: [
            ...
            { question: `Given \\(y=e^{\\sin x}\\sec x\\), find \\(\\frac{dy}{dx}\\).<br>Express your answer in its simplest form.`, answer: `\\((1+\\sec x\\tan x)e^{\\sin x}\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/differentiation#2" },
            ...
            { question: `Differentiate \\(f(x)=\\frac{2x-1}{1-x^2}\\).<br>Simplify the derivative fully.`, answer: `\\(\\frac{2x^2-2x+2}{(1-x^2)^2}\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/differentiation#4" },
            { question: `Differentiate \\(f(x)=\\frac{e^{1+x^2}}{1+x^2}\\).<br>Express the derivative in its simplest form.`, answer: `\\(\\frac{2x^3 e^{1+x^2}}{(1+x^2)^2}\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/differentiation#5" },
            ...
            { question: `\\(f(x)=\\tan^{-1}\\left(\\frac{x}{x^3-4}\\right)\\).<br>Find \\(f'(2)\\).`, answer: `\\(-1\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/differentiation#7" },
            ...
            { question: `A curve is defined parametrically by \\(x=(\\ln t)^2\\), \\(y=2\\ln t\\), where \\(t > 0\\).<br>Find and simplify \\(\\frac{dy}{dx}\\) and \\(\\frac{d^2 y}{dx^2}\\).`, answer: `\\(\\frac{dy}{dx} = \\frac{1}{\\ln t}\\), \\(\\frac{d^2 y}{dx^2} = -\\frac{1}{2(\\ln t)^3}\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/differentiation#11" },
            { question: `The position \\((x,\\,y)\\) of a particle moving in two-dimensional space at time \\(t\\) seconds is given in metres by the parametric equations \\(x=2t\\), \\(y=\\sin t\\), where \\(t\\geqslant 0\\).<br>Find the speed of the particle at time \\(2\\) seconds, correct to \\(3\\) significant figures.`, answer: `\\(2.04\\text{ m/s}\\)`, paper: "2012 Q12" },
            { question: `A curve is defined by \\(y=x^{x^2-2}\\).<br>Use logarithmic differentiation to find \\(\\frac{dy}{dx}\\).<br>Express your answer in terms of \\(x\\).`, answer: `\\(x^{x^2-2}\\left(2x\\ln x+x-\\frac{2}{x}\\right)\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/differentiation#13" },
            { question: `Let \\(e^y=\\frac{(2x-1)e^{3x}}{(4x+1)^2}\\), \\(x\\in\\mathbb{R}\\), \\(x > \\frac{1}{2}\\).<br>Use logarithmic differentiation to find \\(\\frac{dy}{dx}\\).`, answer: `\\(\\frac{2}{2x-1}+3-\\frac{8}{4x+1}\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/differentiation#14" },
            { question: `A spherical balloon of radius \\(r\\) cm is being inflated by a pump at a constant rate of \\(20\\text{ cm}^3\\text{ s}^{-1}\\).<br>Calculate the rate of change of the radius with respect to time when \\(r=5\\). [Note: a sphere has volume \\(V=\\frac{4}{3}\\pi r^3\\).]`, answer: `\\(\\frac{1}{5\\pi}\\text{ cm s}^{-1}\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/differentiation#15" },
            { question: `The radius of a cylindrical column of liquid is decreasing at the rate of \\(0.02\\text{ m s}^{-1}\\) while the height is increasing at the rate of \\(0.01\\text{ m s}^{-1}\\).<br>Find the rate of change of the volume when the radius is \\(0.6\\) metres and the height is \\(2\\) metres. [Recall that the volume of a cylinder is given by \\(V=\\pi r^2 h\\).]`, answer: `\\(-0.0444\\pi\\text{ m}^3\\text{ s}^{-1}\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/differentiation#16" },
            { question: `A curve is defined by the parametric equations \\(x=t^2+t-1\\), \\(y=2t^2-t+2\\) for all \\(t\\).<br>Show that the point \\(A(-1,\\,5)\\) lies on the curve and obtain an equation of the tangent to the curve at the point A.`, answer: `\\(y=5x+10\\)`, paper: "2002 Q3", solutionUrl: "https://www.maths.scot/advanced-higher/differentiation#17" },
          ],
        },
      ],
    },
      ...
      topics: [
        {
          ...
          questions: [
            ...
            { question: `A function is defined on a suitable domain by \\(f(x)=\\frac{3x^2+2}{x^2-2}\\).<br>Obtain equations for the asymptotes of the graph of \\(y=f(x)\\).`, answer: `Vertical asymptotes: \\(x=-\\sqrt{2}\\) and \\(x=\\sqrt{2}\\). Horizontal asymptote: \\(y=3\\).`, solutionUrl: "https://www.maths.scot/advanced-higher/functions-and-graphs#3" },
            { question: `A function is defined on a suitable domain by \\(f(x)=\\frac{x^3-x}{x^2-2x-8}\\).<br>Obtain equations for the asymptotes of the graph of \\(y=f(x)\\).`, answer: `Vertical asymptotes: \\(x=-2\\) and \\(x=4\\). Oblique asymptote: \\(y=x+2\\).`, solutionUrl: "https://www.maths.scot/advanced-higher/functions-and-graphs#4" },
            { question: `The function \\(f\\) is defined on a suitable domain by \\(f(x)=x^2+n\\), where the constant \\(n\\in\\mathbb{R}\\).<br>State whether \\(f\\) is odd, even or neither.<br>Give a reason for your answer.`, answer: `\\(f\\) is even.`, solutionUrl: "https://www.maths.scot/advanced-higher/functions-and-graphs#5" },
            { question: `The function \\(f\\) is defined on a suitable domain by \\(f(x)=x^3\\cos x\\).<br>State whether \\(f\\) is odd, even or neither.<br>Give a reason for your answer.`, answer: `\\(f\\) is odd.`, solutionUrl: "https://www.maths.scot/advanced-higher/functions-and-graphs#6" },
            { question: `The function \\(f\\) is defined on a suitable domain by \\(f(x)=e^{2x}\\).<br>State whether \\(f\\) is odd, even or neither.<br>Give a reason for your answer.`, answer: `\\(f\\) is neither even nor odd.`, solutionUrl: "https://www.maths.scot/advanced-higher/functions-and-graphs#7" },
            { question: `A function is defined on a suitable domain by \\(f(x)=\\frac{3x^2+2}{x^2-2}\\).<br>Determine whether the graph of \\(y=f(x)\\) has any points of inflection.<br>Justify your answer.`, answer: `The graph of \\(y=f(x)\\) has no points of inflection.`, solutionUrl: "https://www.maths.scot/advanced-higher/functions-and-graphs#8" },
      ...
      topics: [
        {
          name: "Matrices",
          questions: [
            { question: `Matrix \\(A\\) is defined by \\(A=\\begin{pmatrix} -4 & -3\\\\ 6 & 5 \\end{pmatrix}\\).<br>Find:<br>(a) \\(A^{-1}\\)<br>(b) \\(A'\\).`, answer: `(a) \\(A^{-1} = \\frac{1}{2}\\begin{pmatrix} -5 & -3\\\\ 6 & 4 \\end{pmatrix}\\)<br>(b) \\(A' = \\begin{pmatrix} -4 & 6\\\\ -3 & 5 \\end{pmatrix}\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/matrices#1" },
            { question: `Matrix \\(P=\\begin{pmatrix} -9 & 3\\\\ n & 4 \\end{pmatrix}\\), where \\(n\\in\\mathbb{R}\\).<br>Find the value of \\(n\\) such that \\(P\\) is singular.`, answer: `\\(n=-12\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/matrices#2" },
            { question: `Matrices \\(A=\\begin{pmatrix} 4 & 2\\\\ 1 & p \\end{pmatrix}\\) and \\(B=\\begin{pmatrix} 8 & 2\\\\ q & 1 \\end{pmatrix}\\).<br>Given that \\(B=2A'\\), find \\(p\\) and \\(q\\).`, answer: `\\(p=\\frac{1}{2}\\), \\(q=4\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/matrices#3" },
            ...
            { question: `A square matrix \\(A\\) is said to be symmetric if \\(A'=A\\) and skew-symmetric if \\(A'=-A\\).<br>For any \\(2\\times 2\\) matrix \\(A\\), show that \\(A+A'\\) is symmetric and \\(A-A'\\) is skew-symmetric.`, answer: `Let \\(A=\\begin{pmatrix} a & b\\\\ c & d \\end{pmatrix}\\). Then \\((A+A')' = A+A'\\), so it is symmetric. \\((A-A')' = -(A-A')\\), so it is skew-symmetric.`, solutionUrl: "https://www.maths.scot/advanced-higher/matrices#5" },
            { question: `\\(A\\) is the matrix \\(\\begin{pmatrix} 3 & 0\\\\ \\lambda & -2 \\end{pmatrix}\\).<br>Show that \\(A^2\\) can be expressed in the form \\(pA+qI\\), stating the values of \\(p\\) and \\(q\\).`, answer: `\\(A^2 = A+6I\\), so \\(p=1\\), \\(q=6\\).`, solutionUrl: "https://www.maths.scot/advanced-higher/matrices#6" },
            { question: `The matrix \\(A=\\begin{pmatrix} 2 & 3 & 1\\\\ -1 & \\mu & 4\\\\ 5 & 0 & -2 \\end{pmatrix}\\).<br>Given that the determinant of \\(A\\) is \\(36\\), determine the value of \\(\\mu\\).`, answer: `\\(\\mu=2\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/matrices#7" },
            ...
            { question: `(a) Write down the \\(2\\times 2\\) matrix \\(M_1\\) associated with reflection in the \\(x\\)-axis.<br>(b) Write down the \\(2\\times 2\\) matrix \\(M_2\\) that represents reflection in the line \\(y=-x\\).<br>(c) Find the \\(2\\times 2\\) matrix \\(M_3\\) associated with reflection in the line \\(y=-x\\) followed by reflection in the \\(x\\)-axis.<br>(d) State the single transformation associated with \\(M_3\\).`, answer: `(a) \\(M_1 = \\begin{pmatrix} 1 & 0\\\\ 0 & -1 \\end{pmatrix}\\)<br>(b) \\(M_2 = \\begin{pmatrix} 0 & -1\\\\ -1 & 0 \\end{pmatrix}\\)<br>(c) \\(M_3 = \\begin{pmatrix} 0 & -1\\\\ 1 & 0 \\end{pmatrix}\\)<br>(d) Anti-clockwise rotation of \\(\\frac{\\pi}{2}\\) radians about the origin.`, solutionUrl: "https://www.maths.scot/advanced-higher/matrices#10" },
      ...
      topics: [
        {
          ...
          questions: [
            ...
            { question: `Show that the greatest common divisor of \\(133\\) and \\(612\\) is \\(1.\\)<br>Hence find \\(x, y \\in \\mathbb Z\\) such that \\(133x+612y=1.\\)`, answer: `\\(x=-23\\) and \\(y=5\\)`, videoId: "nVZV1HfcKPg", timestamp: 453, solutionUrl: "https://www.maths.scot/advanced-higher/number-theory#4" },
      ...
      topics: [
        {
          ...
          questions: [
            { question: `The second and fifth terms of an arithmetic sequence are \\(7\\) and \\(19\\) respectively.<br>Find the sum of the first \\(50\\) terms of this sequence.`, answer: `\\(5050\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/sequences-and-series#1" },
            { question: `The second and fifth terms of an geometric sequence are \\(24\\) and \\(3\\) respectively.<br>Find the sum of the first \\(10\\) terms of this sequence.`, answer: `\\(\\frac{3069}{32}\\) (or \\(95.90625\\))`, solutionUrl: "https://www.maths.scot/advanced-higher/sequences-and-series#2" },
            { question: `A geometric series has first term \\(6\\) and sum to infinity \\(18\\).<br>Find its fourth term.`, answer: `\\(\\frac{16}{9}\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/sequences-and-series#3" },
            { question: `The first three terms of a geometric series are given by \\(x+6\\), \\(x+2\\), \\(x-1\\).<br>Find \\(x\\), explain why this series converges and find the sum to infinity.`, answer: `\\(x=10\\); it converges because \\(-1 < \\frac{3}{4} < 1\\); Sum to infinity is \\(64\\).`, solutionUrl: "https://www.maths.scot/advanced-higher/sequences-and-series#4" },
            ...
            { question: `\\(S_n\\) is defined by \\(\\sum^{n}_{r=1}\\,\\left(r^3-2r\\right)\\).<br>Find and fully factorise an expression for \\(S_{n}\\).`, answer: `\\(\\frac{n(n+1)(n^2+n-4)}{4}\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/sequences-and-series#8" },
            ...
            { question: `The sum of the first twenty terms of an arithmetic sequence is \\(320\\). The twenty-first term is \\(37\\).<br>What is the sum of the first ten terms?`, answer: `\\(60\\)`, paper: "2015 Q3", solutionUrl: "https://www.maths.scot/advanced-higher/sequences-and-series#10" },
      ...
      topics: [
        {
          ...
          questions: [
            ...
            { question: `The points \\((1,-4)\\), \\((2,-2)\\) and \\((3,10)\\) lie on a parabola.<br>Find the equation of the parabola.`, answer: `\\(y=5x^2-13x+4\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/systems-of-equations#2" },
            { question: `Use Gaussian elimination to show that this system of equations involves redundancy (\\(x+y+z=4\\), \\(3x-y+2z=13\\), \\(2x-2y+z=9\\)).<br>Obtain a parametric solution of the system of equations.`, answer: `\\(x=\\frac{-3\\lambda+17}{4}\\), \\(y=-\\frac{\\lambda+1}{4}\\), \\(z=\\lambda\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/systems-of-equations#3" },
            ...
            { question: `Use Gaussian elimination on the system of equations below to give an expression for \\(z\\) in terms of \\(\\lambda\\) (\\(x+2y+6z=5\\), \\(x-4y-2z=1\\), \\(x-y+\\lambda z=-3\\)).<br>For what value of \\(\\lambda\\) is this system of equations inconsistent?`, answer: `\\(z=\\frac{6}{2-\\lambda}\\); inconsistent when \\(\\lambda=2\\).`, solutionUrl: "https://www.maths.scot/advanced-higher/systems-of-equations#5" },
            { question: `Is the following system of equations ill-conditioned?<br>Explain your answer (\\(10x+9y=5\\), \\(9x+8y=4\\)).`, answer: `No, it is well-conditioned.`, solutionUrl: "https://www.maths.scot/advanced-higher/systems-of-equations#6" },
            { question: `Is the following system of equations ill-conditioned?<br>Explain your answer (\\(300x-y=-1\\), \\(299x-y=-2\\)).`, answer: `Yes, it is ill-conditioned.`, solutionUrl: "https://www.maths.scot/advanced-higher/systems-of-equations#7" },
      ...
      topics: [
        {
          ...
          questions: [
            ...
            { question: `A straight line passes through the points \\(A(4,\\,-1,\\,2)\\) and \\(B(-2,\\,3,\\,7)\\).<br>Obtain its symmetric equations.`, answer: `\\(\\frac{x-4}{-6} = \\frac{y+1}{4} = \\frac{z-2}{5}\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/vectors#4" },
            { question: `A plane contains the points \\(P(4,\\,1,\\,-5)\\), \\(Q(-1,\\,-2,\\,1)\\) and \\(R(3,\\,0,\\,-1)\\).<br>Find its Cartesian equation.`, answer: `\\(3x-7y-z=10\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/vectors#5" },
            ...
            { question: `The symmetric equation of a line \\(l\\) is \\(\\frac{x-3}{4} = \\frac{y-2}{-1} = \\frac{z+1}{2}\\). Plane \\(\\pi\\) is defined by the equation \\(2x+y-z=4\\).<br>Find the coordinates of the point of intersection of line \\(l\\) and plane \\(\\pi\\).`, answer: `\\((-1,\\,3,\\,-3)\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/vectors#7" },
            { question: `Three vectors \\(\\overrightarrow{\\textsf{OA}}\\), \\(\\overrightarrow{\\textsf{OB}}\\) and \\(\\overrightarrow{\\textsf{OC}}\\) are given by \\(\\boldsymbol{u}\\), \\(\\boldsymbol{v}\\) and \\(\\boldsymbol{w}\\) where \\(\\boldsymbol{u}=5\\boldsymbol{i}+13\\boldsymbol{j}\\), \\(\\boldsymbol{v}=2\\boldsymbol{i}+\\boldsymbol{j}+3\\boldsymbol{k}\\), \\(\\boldsymbol{w}=\\boldsymbol{i}+4\\boldsymbol{j}-\\boldsymbol{k}\\).<br>Calculate \\(\\boldsymbol{u}\\cdot(\\boldsymbol{v}\\times\\boldsymbol{w})\\).<br>Interpret your result geometrically.`, answer: `\\(0\\); \\(\\boldsymbol{u}\\) lies in the same plane as the one containing both \\(\\boldsymbol{v}\\) and \\(\\boldsymbol{w}\\) (coplanar).`, paper: "2014 Q5" },
