      ...
      topics: [
        {
          ...
          questions: [
            ...
            { question: `The position \\((x,\\,y)\\) of a particle moving in two-dimensional space at time \\(t\\) seconds is given in metres by the parametric equations \\(x=2t\\), \\(y=\\sin t\\), where \\(t\\geqslant 0\\).<br>Find the speed of the particle at time \\(2\\) seconds, correct to \\(3\\) significant figures.`, answer: `\\(2.04\\text{ m/s}\\)`, solutionUrl: "https://www.maths.scot/advanced-higher/differentiation#12" },
            ...
            { ref: "2019 Q10", solutionUrl: "https://www.maths.scot/advanced-higher/differentiation#18" },
            { ref: "2021 P2 Q1", solutionUrl: "https://www.maths.scot/advanced-higher/differentiation#19" },
            { ref: "2022 P1 Q4", solutionUrl: "https://www.maths.scot/advanced-higher/differentiation#20" },
            { ref: "2023 P2 Q1", solutionUrl: "https://www.maths.scot/advanced-higher/differentiation#21" },
            { ref: "2023 P2 Q10", solutionUrl: "https://www.maths.scot/advanced-higher/differentiation#22" },
            { ref: "2024 P2 Q6", solutionUrl: "https://www.maths.scot/advanced-higher/differentiation#23" },
            { ref: "2024 P2 Q10", solutionUrl: "https://www.maths.scot/advanced-higher/differentiation#24" },
            { ref: "2025 P2 Q2", solutionUrl: "https://www.maths.scot/advanced-higher/differentiation#25" },
          ],
        },
      ],
    },
      ...
      topics: [
        {
          ...
          questions: [
            ...
            { question: `Find the coordinates of the point of inflexion on the graph of \\(y=\\sin x+\\tan x\\), where \\(-\\frac{\\pi}{2}< x<\\frac{\\pi}{2}\\).`, answer: `\\((0,\\,0)\\)`, paper: "2016 Exemplar Q10", solutionUrl: "https://www.maths.scot/advanced-higher/functions-and-graphs#10" },
      ...
      topics: [
        {
          ...
          questions: [
            ...
            { question: `Find the exact value of \\(\\Large\\int^{\\small 2\\normalsize}_{\\small 1\\normalsize} \\normalsize \\large\\frac{x\\,+\\,4}{(x\\,+\\,1)^2(2x\\,-\\,1)}\\normalsize\\,dx\\)`, answer: `\\( ln\\,2-\\frac{1}{6} \\)`, videoId: "S3lOe8FCO3k", timestamp: 427, paper: "2016 Specimen Q11", solutionUrl: "https://www.maths.scot/advanced-higher/integration#4" },
            ...
            { question: `Find \\(\\Large\\int\\normalsize\\!x^2\\,e^{3x}\\,dx\\)`, answer: `\\( \\frac{1}{3} x^2\\,e^{3x}-\\frac{2}{9}\\,x\\,e^{3x}+\\frac{2}{27} e^{3x}+c \\)`, videoId: "S3lOe8FCO3k", timestamp: 1203, paper: "2016 Specimen Q5", solutionUrl: "https://www.maths.scot/advanced-higher/integration#8" },
      ...
      topics: [
        {
          ...
          questions: [
            ...
            { question: `Obtain the value(s) of \\(p\\) for which the matrix \\(A=\\begin{pmatrix} p & 2 & 0\\\\ 3 & p & 1\\\\ 0 & -1 & -1 \\end{pmatrix}\\) is singular.`, answer: `\\(p=3\\) or \\(p=-2\\)`, paper: "2015 Q5", solutionUrl: "https://www.maths.scot/advanced-higher/matrices#8" },
