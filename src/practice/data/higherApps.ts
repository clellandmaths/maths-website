      ...
      topics: [
        ...
        },
        {
          ...
          questions: [
            ...
            { question: `A tank holds \\(800\\) litres of liquid.<br>Each day \\(20\\%\\) evaporates and \\(100\\) litres are added.<br>Calculate the long-term limit of the volume in the tank.`, answer: `\\(L = 0.8L + 100\\)<br>\\(0.2L = 100\\)<br>\\(L = 500\\) litres` },
            { question: `A recurrence relation is \\(u_{n+1} = 0.65u_n + 210\\).<br>Calculate the limit of this sequence.`, answer: `\\(L = 0.65L + 210\\)<br>\\(0.35L = 210\\)<br>\\(L = 600\\)` },
            { question: `A forest contains \\(40000\\) trees.<br>Each year \\(8\\%\\) of the trees are felled and \\(2000\\) saplings are planted.<br>(a) Calculate the number of trees after \\(2\\) years.<br>(b) Calculate the long-term limit.`, answer: `(a) \\(u_1 = 0.92 \\times 40000 + 2000 = 38800\\)<br>\\(u_2 = 0.92 \\times 38800 + 2000 = 37696\\) trees<br>(b) \\(L = 0.92L + 2000\\), so \\(0.08L = 2000\\) and \\(L = 25000\\) trees` },
        ...
        },
        {
          ...
          questions: [
            ...
            { question: `The volume of water in a tank is modelled by \\(V = 950 - 35t\\), where \\(t\\) is the time in minutes.<br>Calculate the time taken for the tank to empty.<br>Give your answer to 1 decimal place.`, answer: `\\(950 - 35t = 0\\)<br>\\(t = \\frac{950}{35} = 27.14...\\)<br>\\(27.1\\) minutes` },
            { question: `One firm charges a call-out fee of \\(\\pounds 48\\) plus \\(\\pounds 26\\) per hour.<br>A rival charges a call-out fee of \\(\\pounds 75\\) plus \\(\\pounds 17\\) per hour.<br>Calculate the number of hours for which the two firms charge the same amount.`, answer: `\\(48 + 26h = 75 + 17h\\)<br>\\(9h = 27\\)<br>\\(h = 3\\) hours` },
            ...
            { question: `A linear model passes through the points \\((0, 240)\\) and \\((6, 96)\\).<br>Write down the formula for this model.`, answer: `Gradient \\(= \\frac{96 - 240}{6 - 0} = -24\\)<br>Intercept \\(= 240\\)<br>\\(y = 240 - 24x\\)` },
            { ref: "2025 Q10" },
          ],
        },
        {
          ...
          questions: [
            ...
            { question: `A distress flare is fired vertically.<br>Its height \\(h\\), in metres, after \\(t\\) seconds is modelled by \\(h = 60t - 5t^2\\).<br>Calculate the time at which the flare returns to the ground.`, answer: `\\(60t - 5t^2 = 0\\)<br>\\(5t(12 - t) = 0\\)<br>\\(t = 0\\) or \\(t = 12\\)<br>The flare returns to the ground after \\(12\\) seconds.` },
            { question: `A distress flare has height \\(h = 60t - 5t^2\\) metres after \\(t\\) seconds.<br>Calculate the maximum height reached by the flare.`, answer: `The maximum is halfway between the roots \\(t = 0\\) and \\(t = 12\\), so \\(t = 6\\).<br>\\(h = 60 \\times 6 - 5 \\times 6^2 = 360 - 180 = 180\\)<br>\\(180\\) metres` },
            ...
            { question: `A company models its weekly profit by \\(P = -2p^2 + 60p - 250\\), where \\(p\\) is the selling price in pounds.<br>(a) Calculate the selling price that gives the maximum profit.<br>(b) Calculate that maximum profit.`, answer: `(a) The maximum is at \\(p = \\frac{-60}{2 \\times (-2)} = 15\\), so \\(\\pounds 15\\).<br>(b) \\(P = -2 \\times 225 + 900 - 250 = 200\\), so \\(\\pounds 200\\).` },
