...
export function questionNumber(questionHtml: string): string | null {
 ...
 */
export function lastQuestionNumber(
 ...
 */
export function isWholePaper(
  questions: { year: number | string; paperNumber: number; questionIndex: number }[]
): boolean {
